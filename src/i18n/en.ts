...
export default {
  ...
  homepage:{
    ...
    title: 'Selected Car Service is ready to help with service and repairs of exclusive modern and classic cars. With our workshop for exclusive cars, we have the opportunity to provide the best service for your car in a separate specialist workshop.'
  },
  stats:{
    total: 'Total Capital Raised',
    happy: 'Happy Customers',
    feed: 'Customers Feedback',
    title: {
      w:'WIDE RANGE OF',
      v: 'VEHICLES'
    }
  ...
  form:{
    ...
    placeholder:{
      ...
      username: 'Input Name',
      name: 'Pick up Hotel Name',
      map: 'Enter a City or Airport...'
    },
    diffenrent:'Need a different drop-off location?'
  ...
  cardetail:{
    ...
    label: {
      hotel: {
        label: 'Hotel',
        description: 'A hotel is a comfortable and secure place to stay, designed for travelers, business guests, and families. It offers modern, clean rooms with essential amenities to ensure a relaxing and enjoyable experience throughout your stay.',
        features: {
          a: 'Modern and clean rooms',
          b: 'Free high-speed Wi-Fi',
          c: 'Air conditioning',
          d: '24-hour front desk service',
          e: 'Restaurant and breakfast service',
          f: 'Swimming pool and fitness center (optional)',
          g: 'Convenient city-center location',
          h: 'Secure parking and safety services'
        }
      },
      suvs: {
        label: 'SUV',
