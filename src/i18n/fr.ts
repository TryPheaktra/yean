...
export default {
  ...
  homepage:{
    cardisplay:{
      l:'VOITURE DE LUXE DE',
      d: 'JOUR',
      t: 'Faites-vous plaisir aux États-Unis'
    },
    prem: {
      p:'VOITURE HAUT DE GAMME',
      r: 'DE LOCATION'
    },
    title: 'Selected Car Service est à votre disposition pour l`entretien et la réparation de voitures de collection et modernes haut de gamme. Grâce à notre atelier dédié aux véhicules d`exception, nous vous offrons un service optimal dans un espace spécialisé et indépendant.'
  },
  stats:{
    total: 'Capital total levé',
    happy: 'Clients satisfaits',
    feed: 'Commentaires des clients',
    title: {
      w:'LARGE GAMME DE',
      v: 'VÉHICULES'
    }
  ...
  form:{
    ...
    placeholder:{
      cartype: 'Sélectionnez le type de votre voiture',
      username: 'Nom de l`entrée',
      name: 'Nom de l`hôtel à récupérer',
      map: 'Saisissez une ville ou un aéroport...'
    },
    diffenrent:'Besoin d`un autre lieu de dépôt ?'
  },
  cardetail:{
    header:'Informations sur le véhicule',
    label: {
      hotel: {
        label: 'Hôtel',
        description: 'Un hôtel est un lieu de séjour confortable et sécurisé, conçu pour les voyageurs, les professionnels et les familles. Il propose des chambres modernes et propres, équipées de services essentiels pour garantir un séjour agréable et relaxant.',
        features: {
          a: 'Chambres modernes et propres',
          b: 'Wi-Fi gratuit à haut débit',
          c: 'Climatisation',
          d: 'Réception ouverte 24h/24',
          e: 'Restaurant et service de petit-déjeuner',
          f: 'Piscine et salle de sport (en option)',
          g: 'Emplacement pratique en centre-ville',
          h: 'Parking sécurisé et services de sécurité'
        }
      },
      suvs: {
        label: 'SUV',
  ...
  dialogform: {
    thank: 'Merci d`avoir utilisé notre service.',
